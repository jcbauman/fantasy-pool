...
export const mockScoringMatrix: { [key: string]: number } = {
  ...
  [GameStatKeys.cueHauler]: 0.5,
  [GameStatKeys.skillShots]: 0.3,
  [GameStatKeys.threeBallsPocketedInRow]: 1,
  [GameStatKeys.fourBallsPocketedInRow]: 2,
  [GameStatKeys.fiveBallsPocketedInRow]: 3,
  [GameStatKeys.sixBallsPocketedInRow]: 5,
  [GameStatKeys.sevenBallsPocketedInRow]: 10,
